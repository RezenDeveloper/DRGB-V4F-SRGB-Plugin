  ...
  return [
    {
      ...
      type: 'boolean',
      default: 'true',
      description: 'Uma vez ativado, o canal sem componentes emitirá um efeito de respiração correspondente à cor do seu canal. É recomendado desabilitar essa função após a configuração ser concluída.'
    },
    {
      property: 'HWL_test',
      group: '',
      label: 'Preview Inicialização',
      type: 'boolean',
      default: 'false',
      description: 'Uma vez ativado, você pode depurar o efeito de iluminação de inicialização e desligamento. Após concluir o processo de depuração, clique em Salvar na parte inferior.'
    },
    {
      property: 'HWL_start',
      group: '',
      label: 'Ativar Efeito de Inicialização',
      type: 'boolean',
      default: 'true',
      description: 'Quando ativado, o efeito de iluminação será executado ao sair do software ou durante a inicialização.'
    },
    {
      property: 'HWL_effectMode',
      group: '',
      label: 'Efeito de Inicialização',
      type: 'combobox',
      values: [
        'Rainbow Wave',
        'Color Shift',
    ...
    },
    {
      ...
      group: '',
      label: 'Velocidade do Efeito de Inicialização',
      step: '1',
      type: 'number',
      min: '0',
      max: '2',
    ...
    },
    {
      ...
      group: '',
      label: 'Direção do Efeito de Inicialização',
      type: 'combobox',
      values: ['Start', 'End'],
      default: 'Start',
      description: 'Escolha a direção do efeito de inicialização, podendo ser do Início ou Fim do HUB.'
    },
    {
      property: 'HWL_random',
      group: '',
      label: 'Cores do Efeito de Inicialização Aleatórias',
      type: 'boolean',
      default: 'true',
      description: 'Quando ativado, as cores do efeito de desligamento serão aleatórias.'
    },
    {
      property: 'HWL_color',
      group: '',
      label: 'Cor de Inicialização 1',
      type: 'color',
      min: '0',
      max: '360',
      default: '#FF0000'
    ...
    },
    {
      ...
      max: '100',
      default: '60',
      description: 'Ajuste o brilho global, incluindo o efeito de iluminação de inicialização. (Ajustes frequentes não são recomendados.)'
    },
    {
      property: 'HWL_enable',
      group: '',
      ...
      type: 'boolean',
      default: 'false',
      description: 'Após ajustar o efeito, clique uma vez para atualizar o efeito de iluminação de inicialização e salvar em até 3 segundos. Após salvar, desative a Pré-visualização da Inicialização.'
    }
  ]  
}
